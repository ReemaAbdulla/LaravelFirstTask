...
<section class="padding-lg">
 ...
 <!-- Submit button -->
  ...
  <div class="form-check d-flex justify-content-center mb-4">
  	<pre>
    <input
     class="form-check-input me-2" type="checkbox" value=""  id="form4Example4" checked/> <label class="form-check-label" for="form4Example4" style="color:white">Send me a copy of this message</label></pre>
  </div>
...
<div class="mb-3">
  ...
  <textarea class="form-control" id="exampleFormControlTextarea1" rows="3">Write your message here</textarea>
</div>
 -->
</body>
</html>